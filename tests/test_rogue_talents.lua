...
describe("Rogue Talents", function()
    ...
    ---------------------------------------------------------------------------
    -- 1. Improved Eviscerate (1:7) - +5%/rank DAMAGE_MULT on Eviscerate
    --    3 ranks, additive
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 5. Lethality (1:2) - +6%/rank CRIT_MULT_BONUS, 5 ranks
    ...
    ---------------------------------------------------------------------------
    -- 6. Vile Poisons (1:15) - +4%/rank DAMAGE_MULT on poisons + Envenom
    --    5 ranks, additive
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 7. Precision (2:1) - +1%/rank SPELL_HIT_BONUS, 5 ranks
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 11. Surprise Attacks (2:22) - +10% DAMAGE_MULT on SS/BS/Shiv/Gouge
    --     1 rank, additive
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 12. Opportunity (3:6) - +4%/rank DAMAGE_MULT on BS/Mutilate/Garrote/Ambush
    --     5 ranks, additive
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 14. Serrated Blades (3:14) - +10%/rank DAMAGE_MULT on Rupture
    --     3 ranks, additive
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 15. Heightened Senses (3:16) - +2%/rank HIT, 2 ranks
    ---------------------------------------------------------------------------
    ...
    ---------------------------------------------------------------------------
    -- 16. Dirty Deeds (3:9) - +10%/rank DAMAGE_MULT global, 2 ranks,
    ...
    ---------------------------------------------------------------------------
    -- 17. Sinister Calling (3:19) - +1%/rank DAMAGE_MULT on BS/Hemo
    --     5 ranks, additive
    ---------------------------------------------------------------------------
    ...
    describe("Stacking", function()
        ...
        it("Aggression + Surprise Attacks should stack additively on SS", function()
            local state = makeRogueState()
            state.talents["2:17"] = 3  -- Aggression +6%
            state.talents["2:22"] = 1  -- Surprise Attacks +10%
            local r = Pipeline.Calculate(1752, state)
        ...
        it("Opportunity + Sinister Calling should stack additively on BS", function()
            local state = makeDaggerRogueState()
            state.talents["3:6"] = 5   -- Opportunity +20%
            state.talents["3:19"] = 5  -- Sinister Calling +5%
            local r = Pipeline.Calculate(53, state)
        ...
        it("Improved Eviscerate + Aggression should stack additively on Evis", function()
            local state = makeRogueState()
            state.talents["1:7"] = 3   -- Imp Evis +15%
            state.talents["2:17"] = 3  -- Aggression +6%
            local r = Pipeline.Calculate(2098, state)
        ...
        it("Precision + Heightened Senses should stack hit on SS", function()
            local state = makeRogueState()
            state.talents["2:1"] = 5   -- Precision +5% hit
            state.talents["3:16"] = 2  -- Heightened Senses +4% hit
            local r = Pipeline.Calculate(1752, state)
