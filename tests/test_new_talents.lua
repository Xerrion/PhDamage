...
-------------------------------------------------------------------------------
-- Demonic Tactics (talent 2:20) removed from TalentMap (plan 44, Bug A);
-- the +1%/rank crit it provided is now counted in stats.spellCrit only.
-- Tests for the standalone talent and stacking with Devastation are removed.
-------------------------------------------------------------------------------
